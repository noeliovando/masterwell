...
<link rel="stylesheet" href="<?php echo BASE_PATH; ?>/styles/well_directory_edit.css?v=<?php echo time(); ?>">


<div class="well-edit-container">
    <div class="well-edit-header">
        <h1>Datos Generales de Pozo: <?php echo htmlspecialchars($well_details['UWI'] ?? 'S/I'); ?></h1>
    </div>
    ...
    <?php endif; ?>
        ...
        <?php if ($well_details): ?>
                ...
                <div class="details-grid">
                    ...
                    <div class="column-section">
                        ...
                        <div class="card">
                            ...
                            <p><strong>CLASIFICACION LAHEE INICIAL:</strong>
                                ...
                                <select name="INITIAL_CLASS" class="editable-field searchable-select" data-field="INITIAL_CLASS" style="display: none;">
                    ...
                    <div class="column-section">
                        ...
                        <div class="card">
                            ...
                            <p><strong>COMPAÑIA PERFORADORA:</strong>
            ...
            <div class="related-wells-section">
                <h2 class="detail-section">HOYOS VINCULADOS</h2>
