...
$backUrl = BASE_PATH . '/wells-directory';
$editUrl = BASE_PATH . '/well?search_well=' . urlencode($uwi) . '&edit=1';
$listUrl = BASE_PATH . '/wells-directory?uwi=' . urlencode($uwi);
?>
...
<div class="details-wrapper">
  <div class="page-title">
    ...
    <div class="actions">
      ...
      <a class="btn" href="<?php echo h($listUrl); ?>">Ver en grid</a>
